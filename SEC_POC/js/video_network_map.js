...
Network = function() {
	var allData, charge, curLinksData, curNodesData, filter, filterLinks, filterNodes, force, forceTick, groupCenters, height, hideDetails, highlight, layout, link, linkedByIndex, linksG, mapNodes, moveToRadialLayout, neighboring, network, node, nodeColors, nodeCounts, nodesG, radialTick, rankNumber, setFilter, setLayout, setSort, setHighlight, setupData, showDetails, sort, sortedClusters, strokeFor, tooltip, update, updateCenters, updateLinks, updateNodes, width;
	width = 1024;
	height = 600;
	rankNumber = 11; //it means less than 10
	allData = [];
	curLinksData = [];
	curNodesData = [];
	linkedByIndex = {};
	...
	setupData = function(data) {
		...
		data.nodes.forEach(function(n) {
			var randomnumber;
			n.fixed = true;
			n.x = rescaleX(n.pos_x);
			n.y = rescaleY(n.pos_y);
